...
async function main() {
  ...
  const businessProfile = await prisma.businessProfile.upsert({
    ...
    create: {
      ...
      metrics: {
        ...
        description: 'Full-service architecture and engineering firm specializing in commercial, residential, and institutional projects',
        founded: '2008',
        locations: ['New York', 'Boston', 'Philadelphia'],
        specialties: ['Sustainable Design', 'Historic Preservation', 'Mixed-Use Development', 'Educational Facilities'],
        goals: [
        ...
        context: 'Mid-size A&E firm focused on high-quality design, sustainable practices, and client satisfaction in the Northeast market'
      }
    }
  });
  ...
  const issues = [
    ...
    {
      description: 'Resource allocation across 15+ concurrent projects is managed through spreadsheets and personal knowledge. Project managers struggle to identify available architects, engineers, and specialists with the right skills and availability. This leads to overallocation, burnout, and missed deadlines.',
      votes: 9,
      heatmapScore: 84,
      department: 'Project Management',
    ...
    {
      description: 'Client change requests often arrive mid-project without proper impact assessment on timeline, budget, and scope. These changes ripple through design, engineering, and documentation phases, causing scope creep and budget overruns.',
      votes: 8,
      heatmapScore: 76,
      department: 'Project Management',
    ...
    {
      description: 'CAD file version control is manual and error-prone. Architects work on outdated drawings, leading to coordination conflicts between architectural, structural, and MEP designs. We have had instances where structural elements conflicted with architectural features in final drawings.',
      votes: 11,
      heatmapScore: 91,
    ...
    {
      description: 'Design standards and firm guidelines are scattered across different documents and not consistently applied. New team members struggle to understand design preferences, leading to rework and inconsistent deliverables.',
      votes: 6,
      heatmapScore: 67,
      department: 'Architecture Design',
    ...
    {
      description: 'Client presentations require significant time to prepare renderings, drawings, and materials. The process is manual and time-intensive, often requiring 20-30 hours of preparation for major presentations.',
      votes: 7,
      heatmapScore: 63,
      department: 'Architecture Design',
    ...
    // Engineering Issues
    {
      description: 'Coordination between structural, mechanical, electrical, and plumbing systems happens too late in the design process. Conflicts are discovered during documentation phase, requiring significant rework and design modifications.',
      votes: 10,
      heatmapScore: 86,
      department: 'Engineering',
    ...
    {
      description: 'Engineering calculations and analysis are performed in multiple software tools without central coordination. Results are difficult to verify, update, and share across the team, leading to potential errors and rework.',
      votes: 8,
      heatmapScore: 79,
      department: 'Engineering',
    ...
    {
      description: 'Code compliance verification is manual and depends heavily on individual engineer expertise. Code updates and changes are not systematically tracked, creating risk of non-compliance in projects.',
      votes: 9,
      heatmapScore: 82,
      department: 'Engineering',
    ...
    {
      description: 'Project profitability tracking is done post-completion, making it impossible to course-correct during execution. We lack real-time visibility into labor costs, consultant fees, and project margins.',
      votes: 7,
      heatmapScore: 74,
      department: 'Operations',
    ...
    {
      description: 'Marketing materials and project portfolios become outdated quickly. Maintaining current project photos, descriptions, and case studies requires significant effort and often falls behind.',
      votes: 5,
      heatmapScore: 58,
    ...
    {
      description: 'Knowledge management is informal and relies on institutional memory. When senior staff leave, critical project knowledge and client relationships are at risk of being lost.',
      votes: 8,
      heatmapScore: 77,
      department: 'Operations',
    ...
    {
      description: 'Software licenses and tool access vary by department, creating compatibility issues when sharing files. CAD, BIM, engineering analysis, and project management tools do not integrate well.',
      votes: 9,
      heatmapScore: 81,
      department: 'Operations',
    ...
    {
      description: 'Remote work capabilities are inconsistent across teams. Some staff can access all necessary tools remotely while others are limited, affecting collaboration and flexibility.',
      votes: 6,
      heatmapScore: 69,
      department: 'Operations',
  ...
  const initiatives = [
    // IDENTIFY Phase - Problem Discovery
    {
      ...
      problem: 'Design review cycles with municipal authorities are unpredictable and lack visibility',
    ...
    },
    {
      ...
      department: 'Engineering',
      kpis: ['Document 100% of coordination touchpoints', 'Identify 5+ early integration opportunities'],
    ...
    // PLAN Phase - Solution Development
    {
      ...
      type: 'Technology',
      department: 'Project Management',
      kpis: ['Reduce approval cycle time by 40%', 'Increase client satisfaction by 25%', '100% of projects use portal'],
    ...
    // EXECUTE Phase - Implementation
    {
      ...
      progress: 70,
      department: 'Operations',
      kpis: ['Reduce file search time by 75%', '100% version control compliance', 'Zero version conflicts'],
  ...
  const teams = [
    ...
    },
    {
      ...
      skills: ['Structural Analysis', 'ETABS', 'SAP2000', 'Steel Design', 'Concrete Design', 'Seismic Design']
    },
    {
      name: 'MEP Engineering',
      department: 'Engineering',
      capacity: 80, // 2 engineers * 40 hours
      skills: ['HVAC Design', 'Electrical Systems', 'Plumbing Design', 'AutoCAD MEP', 'Energy Modeling']
    },
    {
      name: 'Project Management Office',
      department: 'Project Management',
      capacity: 200, // 5 PMs * 40 hours
      skills: ['Project Coordination', 'Scheduling', 'Budget Management', 'Client Relations', 'Quality Control']
    },
    {
      name: 'Interior Design',
      department: 'Design',
      capacity: 80, // 2 designers * 40 hours
      skills: ['Space Planning', 'Material Selection', 'FF&E Specification', '3D Visualization', 'Color Theory']
    }
  ];
  ...
  const ideas = [
    {
      ...
      description: 'Implement VR technology for immersive client presentations of architectural designs. This would allow clients to walk through spaces before construction and make more informed decisions about design changes.',
      authorDept: 'Design',
      category: 'technology',
      priority: 'medium',
      status: 'idea',
    ...
    },
    {
      ...
      description: 'Develop AI-powered system to automatically check designs against current building codes and zoning requirements. This would catch compliance issues early and reduce review cycles.',
    ...
    },
    {
      ...
      description: 'Create automated scoring system for design sustainability that tracks LEED points, energy efficiency, and environmental impact in real-time during the design process.',
      authorDept: 'Design',
      category: 'strategy',
      priority: 'medium',
      status: 'approved',
    ...
    },
    {
      ...
      description: 'Develop mobile application for clients to review designs, approve changes, and communicate with project teams from their smartphones and tablets.',
    ...
    },
    {
      ...
      description: 'Implement IPD methodology to improve collaboration between architects, engineers, and contractors from project inception through completion.',
    ...
    },
    {
      ...
      description: 'Use drone technology for site surveys and progress monitoring, integrating aerial photography and 3D mapping into our design workflow.',
      authorDept: 'Engineering',
      category: 'technology',
      priority: 'low',
      status: 'idea',
    ...
    },
    {
      ...
      description: 'Create intelligent search system for internal knowledge base that can find relevant project details, lessons learned, and best practices using natural language queries.',
      authorDept: 'Operations',
      category: 'process',
      priority: 'medium',
      status: 'idea',
    ...
    },
    {
      ...
      description: 'Develop platform to evaluate and track contractor performance, qualifications, and project history to improve selection and partnership decisions.',
      authorDept: 'Project Management',
      category: 'process',
      priority: 'medium',
      status: 'approved',
  ...
  const usersByDept = {
    ...
    'Project Management': createdUsers.find(u => u.preferences?.department === 'Project Management'),
  ...
  const ideaComments = [
    {
      ...
      content: 'This could be a major differentiator for us. Several competitors are starting to offer VR. We should evaluate the ROI and client feedback potential.'
    },
    {
      ideaIndex: 0,
      authorDept: 'Operations',
      content: 'Initial cost would be significant - VR equipment, software licenses, and training. But it could reduce design changes late in the process.'
    },
    {
      ideaIndex: 1, // Code Checker
      authorDept: 'Executive',
      content: 'Automated code checking could save us thousands in review costs and reduce liability. This should be high priority.'
    },
    {
      ideaIndex: 1,
      authorDept: 'Engineering',
      content: 'The technology exists but needs customization for our local codes. Would need to maintain code database updates regularly.'
    },
    {
      ideaIndex: 2, // Sustainability Scoring
      authorDept: 'Design',
      content: 'More clients are requesting sustainable design. Real-time scoring would help us optimize designs during the process rather than retrofitting.'
    },
    {
      ideaIndex: 4, // IPD Workflow
      authorDept: 'Project Management',
      content: 'IPD requires significant process changes but the collaboration benefits are proven. We should pilot this on a smaller project first.'
    }
  ];
  ...
  for (let i = 0; i < 45; i++) {
    ...
    if (randomAction.includes('AI_')) {
      ...
      details = {
        ...
        department: ['Project Management', 'Architecture Design', 'Engineering', 'Operations'][Math.floor(Math.random() * 4)]
      };
    } else if (randomAction.includes('DESIGN')) {
      details = {
        projectType: ['Commercial', 'Residential', 'Educational', 'Healthcare'][Math.floor(Math.random() * 4)],
  ...
  console.log('');
  console.log(`📈 Total entries: ${createdIssues.length} issues, ${createdInitiatives.length} initiatives, ${createdTeams.length} teams, ${createdIdeas.length} ideas, 45+ audit logs`);
}
