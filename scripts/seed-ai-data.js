...
async function main() {
  ...
  const businessProfile = await prisma.businessProfile.upsert({
    ...
    create: {
      ...
      metrics: {
        ...
        description: 'Professional architecture firm specializing in commercial and residential projects',
        goals: ['Improve client approval workflows', 'Reduce project timeline delays', 'Enhance team collaboration'],
        challenges: ['Complex approval processes', 'Communication bottlenecks', 'Resource allocation'],
        context: 'Mid-size A&E firm focused on streamlining operations and improving client satisfaction'
      }
    }
  });
  ...
  const issues = [
    {
      description: 'Our current client approval process for design iterations is taking 3-4 weeks per round. Clients receive design proposals via email, often get lost in communication, multiple stakeholders need to coordinate, and we lack a centralized tracking system. This is causing project delays and client frustration. Impact: Delays project timelines by 20-30%, client satisfaction scores dropping.',
      votes: 8,
      heatmapScore: 85
    },
    {
      description: 'Project managers struggle to allocate architects and engineers effectively across multiple concurrent projects. We have visibility gaps into individual workloads, skill requirements, and availability. This leads to burnout, missed deadlines, and quality issues. Impact: Team utilization at 60%, 15% project overruns, staff burnout.',
      votes: 6,
      heatmapScore: 72
    },
    {
      description: 'Project files are scattered across email, shared drives, and various cloud platforms. Version control is manual and error-prone. Team members waste 2-3 hours daily searching for correct file versions, and we have had instances of presenting outdated designs to clients. Impact: Productivity loss, version control errors, client trust issues.',
      votes: 9,
      heatmapScore: 91
    }
  ];
  ...
  console.log(`🏢 Business profile: ${businessProfile.metrics.companyName}`);
