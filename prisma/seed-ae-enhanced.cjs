...
async function main() {
  ...
  const communicationCluster = await prisma.issueCluster.create({
    data: {
      ...
      description:
        'Issues related to client communication, approval processes, and project coordination with builder teams',
  ...
  const coordinationCluster = await prisma.issueCluster.create({
    data: {
      ...
      description:
        'Challenges with project scheduling, resource allocation, and timeline coordination across multiple communities',
  ...
  const technologyCluster = await prisma.issueCluster.create({
    data: {
      ...
      description:
        'Technology adoption challenges, documentation standards, and system integration issues',
      category: 'technology',
      severity: 'medium',
  ...
  const qualityCluster = await prisma.issueCluster.create({
    data: {
      ...
      description:
        'Quality assurance processes, deliverable consistency, and client satisfaction issues',
      category: 'quality',
      severity: 'medium',
  ...
  const legacyProcessCluster = await prisma.issueCluster.create({
    data: {
      ...
      description:
        'Older manual processes that could benefit from automation but are not critical pain points',
      category: 'process',
      severity: 'low',
  ...
  const emergencyResponseCluster = await prisma.issueCluster.create({
    data: {
      ...
      description:
        'Critical infrastructure for handling project emergencies and ensuring business continuity during disruptions',
      category: 'risk',
      severity: 'critical',
  ...
  await prisma.issue.createMany({
    data: [
      {
        description:
          'Builder approval process takes 3-4 weeks due to multiple stakeholder reviews and unclear approval hierarchy',
        votes: 12,
        heatmapScore: 92,
      ...
      {
        description:
          'Client design revisions are not tracked systematically, leading to scope creep and budget overruns',
        votes: 10,
        heatmapScore: 87,
        department: 'Design',
        category: 'process',
      ...
      {
        description:
          'Municipal review feedback integration process lacks standardization across different jurisdictions',
        votes: 8,
        heatmapScore: 78,
        department: 'Project Management',
        category: 'process',
      ...
      {
        description:
          'Communication gaps between design and engineering teams cause rework on community infrastructure plans',
        votes: 9,
        heatmapScore: 82,
        department: 'Design',
        category: 'communication',
  ...
  await prisma.issue.createMany({
    data: [
      {
        description:
          'Multiple community projects competing for same senior architect resources, causing bottlenecks',
        votes: 11,
        heatmapScore: 89,
        department: 'Project Management',
        category: 'resources',
      ...
      {
        description:
          'Project timeline dependencies between civil engineering and architectural design not properly mapped',
        votes: 9,
        heatmapScore: 84,
        department: 'Engineering',
        category: 'coordination',
      ...
      {
        description:
          'Lack of visibility into team capacity for upcoming community phases affects proposal commitments',
        votes: 7,
        heatmapScore: 76,
        department: 'Business Development',
        category: 'planning',
  ...
  await prisma.issue.createMany({
    data: [
      {
        description:
          'BIM standards inconsistency between architectural and engineering teams creates integration challenges',
        votes: 8,
        heatmapScore: 79,
        department: 'Engineering',
        category: 'technology',
      ...
      {
        description:
          'Document version control across multiple community projects needs improvement for builder coordination',
        votes: 6,
        heatmapScore: 71,
        department: 'Project Management',
      ...
      {
        description:
          'CAD drawing standards vary between teams, affecting deliverable consistency for national builders',
        votes: 5,
        heatmapScore: 68,
        department: 'Design',
        category: 'standards',
  ...
  await prisma.issue.createMany({
    data: [
      {
        description:
          'Quality review checklist for community master plans needs standardization across project managers',
        votes: 7,
        heatmapScore: 74,
        department: 'Project Management',
        category: 'quality',
      ...
      {
        description:
          'Inconsistent deliverable formats across different builder relationships affect professional presentation',
        votes: 6,
        heatmapScore: 69,
        department: 'Design',
      ...
      {
        description:
          'Manual timesheet compilation process taking 2-3 hours weekly per project manager',
        votes: 3,
        heatmapScore: 25,
      ...
      {
        description:
          'Lack of documented emergency procedures for critical project delays or technical failures',
        votes: 12,
        heatmapScore: 95,
        department: 'Operations',
  ...
  const approvalWorkflowInit = await prisma.initiative.create({
    data: {
      ...
      problem:
        'Builder approval processes are taking 3-4 weeks due to unclear hierarchy and manual tracking, causing project delays and client frustration',
  ...
  const resourcePlanningInit = await prisma.initiative.create({
    data: {
      ...
      problem:
        'Multiple community projects competing for resources without visibility into team capacity, causing bottlenecks and proposal commitment issues',
  ...
  const bimStandardsInit = await prisma.initiative.create({
    data: {
      ...
      problem:
        'Inconsistent BIM standards between teams and poor CAD drawing standardization affecting deliverable quality and client confidence',
      goal: 'Establish unified BIM/CAD standards and integration processes to ensure consistent, high-quality deliverables',
      kpis: [
        'Deliverable Consistency Score',
  ...
  const qaProcessInit = await prisma.initiative.create({
    data: {
      ...
      problem:
        'Inconsistent quality review processes and deliverable formats across projects affecting professional presentation and client confidence',
      ...
      kpis: [
        ...
        'Client Satisfaction',
        'Deliverable Standardization Rate',
        'Review Efficiency',
      ],
      requirements: [
  ...
  const dashboardInit = await prisma.initiative.create({
    data: {
      ...
      problem:
        'Lack of real-time project visibility for stakeholders causing frequent status meetings and communication delays',
  ...
  const clientPortalInit = await prisma.initiative.create({
    data: {
      ...
      problem:
        'Builders lack self-service access to project status, drawings, and approval workflows, causing excessive email communication',
  ...
  const skillsDevInit = await prisma.initiative.create({
    data: {
      ...
      problem:
        'Skills gaps in emerging technologies (AI, sustainable design, advanced BIM) limiting competitive advantage',
  ...
  const sustainabilityInit = await prisma.initiative.create({
    data: {
      ...
      problem:
        'Growing builder demand for sustainable design solutions without integrated sustainability assessment and reporting capabilities',
      goal: 'Develop integrated sustainability framework for all community development projects with automated reporting',
      kpis: [
        'Sustainability Score',
        'Green Certification Rate',
    ...
    data: [
      {
        ...
        description:
          'System must support configurable approval hierarchies for different builder clients with role-based permissions',
        priority: 'HIGH',
        status: 'APPROVED',
      ...
      },
      {
        ...
        description:
          'Send automated notifications to stakeholders when approvals are pending, completed, or overdue',
        priority: 'HIGH',
        status: 'REVIEW',
        category: 'Automation',
        assignedToId: projectDirector.id,
      ...
      },
      {
        ...
        description:
          'Provide mobile-friendly interface for stakeholders to review and approve items on-the-go',
        priority: 'MEDIUM',
        status: 'DRAFT',
      ...
      },
      {
        ...
        description:
          'System must handle concurrent approvals from 50+ stakeholders without performance degradation',
        priority: 'MEDIUM',
        status: 'DRAFT',
  ...
  const clientPortalIdea = await prisma.idea.create({
    data: {
      ...
      description:
        'Allow builder clients to access real-time project status, view deliverables, and submit feedback through a dedicated portal. This would reduce PM workload and improve transparency.',
  ...
  const resourceForecastIdea = await prisma.idea.create({
    data: {
      ...
      description:
        'Implement machine learning to predict resource needs based on historical project data, seasonal patterns, and builder pipeline information.',
  ...
  const bimTrainingIdea = await prisma.idea.create({
    data: {
      ...
      description:
        'Establish internal BIM certification program to ensure all team members meet standardized competency levels and stay current with industry best practices.',
  ...
  const qualityDashboardIdea = await prisma.idea.create({
    data: {
      ...
      description:
        'Create executive dashboard showing quality metrics across all projects, including client satisfaction, rework rates, and compliance scores.',
  ...
  await prisma.comment.create({
    data: {
      content:
        'I think we should prioritize the mobile interface early. Our builder clients are increasingly mobile-first, and this could be a key differentiator.',
      authorId: businessDev.id,
      initiativeId: approvalWorkflowInit.id,
  ...
  await prisma.comment.create({
    data: {
      content:
        'Agreed on mobile priority. We should also consider integration with our existing project management tools to avoid duplicate data entry.',
      authorId: projectDirector.id,
      initiativeId: approvalWorkflowInit.id,
  ...
  await prisma.comment.create({
    data: {
      content:
        'Mobile interface is definitely the way to go. I can help with the technical requirements and API design for the mobile app integration.',
  ...
  await prisma.comment.create({
    data: {
      content:
        'The new BIM standards are looking great. We should make sure to include specific guidelines for MEP coordination to avoid the integration issues we had on the Riverside Commons project.',
      authorId: engineeringDirector.id,
      initiativeId: bimStandardsInit.id,
  ...
  await prisma.comment.create({
    data: {
      content:
        "Good point on MEP coordination. I've added that to our standards document. We should also schedule training sessions for the junior staff once we finalize everything.",
      authorId: designDirector.id,
      initiativeId: bimStandardsInit.id,
  ...
  await prisma.comment.create({
    data: {
      content:
        "This client portal idea aligns perfectly with what we're hearing from our national builder partners. They want more transparency and self-service capabilities.",
      authorId: principal.id,
  ...
  await prisma.comment.create({
    data: {
      content:
        'The AI forecasting concept is intriguing, but we should start with basic analytics first. Once we have good historical data, we can layer on the machine learning.',
      authorId: projectDirector.id,
  ...
  console.log('📊 Summary:');
  console.log(
    '   👥 Users: 5 (Principal, Design Director, Project Director, Business Dev, Engineering Director)'
  );
  console.log('   🏢 Teams: 4 (Design, Engineering, Project Management, Business Development)');
  console.log(
    '   🎯 Issue Clusters: 6 (Communication, Coordination, Technology, Quality, Legacy Process [INACTIVE], Emergency Response [CRITICAL])'
  );
  console.log(
    '   📋 Issues: 14 (covering all major A&E operational areas with diverse cluster assignments)'
  );
  console.log(
    '   🚀 Initiatives: 8 (diverse statuses: ACTIVE×3, APPROVED×2, COMPLETED×1, DRAFT×1, PLANNING×1)'
  );
