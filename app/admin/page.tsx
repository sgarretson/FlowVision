  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Link href="/admin/users" className="card-tertiary p-6 hover:shadow-card-secondary transition-shadow group">
        ...
        <Link href="/admin/settings" className="card-tertiary p-6 hover:shadow-card-secondary transition-shadow group">
