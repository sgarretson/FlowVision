  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="card-tertiary p-6 hover:shadow-card-secondary transition-shadow group cursor-pointer" onClick={() => alert('User management coming soon')}>
        ...
        <div className="card-tertiary p-6 hover:shadow-card-secondary transition-shadow group cursor-pointer" onClick={() => alert('Settings coming soon')}>
