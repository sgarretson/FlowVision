  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex items-center justify-between">
        ...
        <Link href={"/admin/users/new" as any} className="btn-primary">
          Add New User
        </Link>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Link href={"/admin/users" as any} className="card-tertiary p-6 hover:shadow-card-secondary transition-shadow group">
        ...
        <Link href={"/admin/openai" as any} className="card-tertiary p-6 hover:shadow-card-secondary transition-shadow group">
          <div className="w-12 h-12 bg-purple-100 rounded-lg flex items-center justify-center mx-auto mb-4 group-hover:bg-purple-200 transition-colors">
            <svg className="w-6 h-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <Link href={"/admin/settings" as any} className="card-tertiary p-6 hover:shadow-card-secondary transition-shadow group">
      ...
      <div className="card-secondary">
        <div className="p-6 border-b border-gray-200">
          <div className="flex items-center justify-between">
            ...
            <Link href={"/admin/users" as any} className="text-sm text-primary hover:underline">
              View All Users
            </Link>
          </div>
        </div>
